...
namespace Seldino.Repository.DataContexts
{
    ...
    {
        public DataContext() : base("Seldino")
        {
            if (Convert.ToBoolean(ConfigurationHelper.GetSetting("IsAutoMigrationEnabled")))
            {
        ...
        public DbSet<UnauthorizedBasketItem> UnauthorizedBasketItems { get; set; }
